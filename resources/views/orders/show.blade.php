				...
				<div class="panel-body">
					<table class="table">
						...
						<tr>
							...
							<th class="text-center item-amount">小计</th>
						</tr>
						</thead>
						@foreach($order->items as $index => $item)
							<tr>
								<td class="product-info">
									...
									<div>
										<span class="product-title"><a href="{{ route('products.show', [$item->product_id]) }}" target="_blank">{{ $item->product->title }}</a></span>
					...
					<div class="order-bottom">
						<div class="order-info">
							<div class="line"><div class="line-label">收货地址：</div><div class="line-value">{{ implode(' ', $order->address) }}</div></div>
