			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<user-addresses-create-and-edit inline-template>
						@if($address->id)
							<form role="form" class="form-horizontal" method="POST" action="{{ route('user_addresses.update', [$address->id]) }}">
							{{ method_field('PUT') }}
						@else
							<form role="form" class="form-horizontal" method="POST" action="{{ route('user_addresses.store') }}">
						@endif
							{{ csrf_field() }}
