...
class CouponCode extends Model
{
    ...
    protected $fillable = ['name', 'code', 'type', 'value', 'total',
        'used', 'min_amount', 'not_before', 'not_after', 'enabled',
    ];
    ...
    public function changeUsed($increase = true)
    {
        if ($increase) {
            ...
            return $this->newQuery()->where('id', $this->id)->where('used', '>',  0)->decremetn('used');
        }
    }
}
